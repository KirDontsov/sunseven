        ...
        <Section>
          ...
          <div className="w-full flex flex-col items-center gap-4">
            <div className="container h-fit w-full flex flex-col gap-4 px-8 py-10 overflow-hidden bg-white shadow-2xl rounded-xl dark:bg-eboni-800">
              <p>
                Настоящая Политика Sunseven.ru в отношении обработки персональных данных (далее – Политика) разработана
                ...
                ответственностью «Sun seven» (далее – Sun seven и (или) Оператор) с целью защиты прав и свобод человека
              ...
              <ul className="space-y-1 list-disc list-inside">
                ...
                <li>
                  Онлайн-ресурс Sun seven (далее также — «Sun seven») — ресурс в сети Интернет, представляющий собой
                  ...
                  Онлайн-ресурс Sun seven размещён в сети Интернет в открытом доступе на доменах Sunseven.ru, включая
                ...
                <li>
                  Пользователь Sun seven - физическое лицо, не являющееся Лицензиатом и(или) его представителем или
                  плательщиком, которое посредством доступа к Sun seven осуществляет поиск организаций, оказывающих
              ...
              <p>
                ...
                программе, с помощью которой осуществляет доступ к Sun seven) и другие технологии цифрового
                маркирования. Sun seven также может содержать ссылки (представленные в форме гиперссылок, виджетов,
